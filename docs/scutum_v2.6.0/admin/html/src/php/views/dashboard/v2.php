        ...
        <div data-uk-grid>
            <div class="uk-width-2-3@l">
                <div class="uk-card">
                        ...
                        <div class=" uk-flex-middle uk-grid-small" data-uk-grid>
                            <div class="uk-flex-1">
                                <div class="uk-button-group sc-button-group-outline">
                                    <button class="sc-button sc-button-default sc-button-outline sc-button-small sc-js-chart-view" data-view="hours">Hours</button>
                                    <button class="sc-button sc-button-default sc-button-outline sc-button-small sc-js-chart-view" data-view="week">Week</button>
                                    <button class="sc-button sc-button-default sc-button-outline uk-active sc-button-small sc-js-chart-view" data-view="months">Months</button>
                                    <button class="sc-button sc-button-default sc-button-outline sc-button-small sc-js-chart-view" data-view="years">Years</button>
                                </div>
                            </div>
                    ...
                    <div class="sc-card-content">
                        <div class="sc-padding-medium" dir="ltr">
            ...
            <div class="uk-width-1-3@l">
                <div class="uk-card">
                    ...
                    <div class="uk-card-body">
                        <div class="sc-chart uk-flex uk-flex-center" id="sc-js-chart-referrals" dir="ltr">
                            <div class="uk-flex uk-flex-middle uk-height-1-1 uk-flex-center">
                                <div class="sc-spinner"></div>
                            </div>
                        </div>
                ...
                <div class="uk-overflow-auto">
                    <table class="uk-table uk-table-striped uk-table-hover uk-table-middle">
                        ...
                        <tr>
                            ...
                            <th class="<?php rtlReplace('uk-text-right', ''); ?>">Price</th>
                        ...
                        <?php for($i=1;$i<=10;$i++) { ?>
                            ...
                            ?>
                            <tr>
                                <td class="<?php rtlReplace('uk-text-right', ''); ?>"><?php echo $i;?></td>
                                ...
                                <td class="<?php rtlReplace('uk-text-right', ''); ?>">$<?php echo $prices[$i]; ?></td>
