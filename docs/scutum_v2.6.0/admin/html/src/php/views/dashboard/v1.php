					...
					<div class="sc-card-content">
                        ...
                        <div class="uk-overflow-auto">
                            <table class="uk-table uk-table-divider uk-table-striped uk-table-hover uk-table-middle sc-js-map-table uk-margin-remove">
                                ...
                                <tbody>
                                <tr data-region="br">
                                    <td class="uk-table-shrink <?php rtlReplace('sc-padding-left', 'sc-padding-right'); ?>"><span class="flag flag-br"></span></td>
                                    <td><strong>Brasil</strong></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(1000,40000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(1000,40000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(1000,40000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(1000,40000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(1000,40000), 0, ',', ' ');?></td>
                                ...
                                <tr data-region="us">
                                    <td class="uk-table-shrink <?php rtlReplace('sc-padding-left', 'sc-padding-right'); ?>"><span class="flag flag-us"></span></td>
                                    <td><strong>USA</strong></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(10000,50000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(10000,50000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(10000,50000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(10000,50000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(10000,50000), 0, ',', ' ');?></td>
                                ...
                                <tr data-region="pl">
                                    <td class="uk-table-shrink <?php rtlReplace('sc-padding-left', 'sc-padding-right'); ?>"><span class="flag flag-pl"></span></td>
                                    <td><strong>Poland</strong></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(1000,10000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(1000,10000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(1000,10000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(1000,10000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(1000,10000), 0, ',', ' ');?></td>
                                ...
                                <tr data-region="au">
                                    <td class="uk-table-shrink <?php rtlReplace('sc-padding-left', 'sc-padding-right'); ?>"><span class="flag flag-au"></span></td>
                                    <td><strong>Australia</strong></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(5000,30000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(5000,30000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(5000,30000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(5000,30000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(5000,30000), 0, ',', ' ');?></td>
                                ...
                                <tr data-region="cn">
                                    <td class="uk-table-shrink <?php rtlReplace('sc-padding-left', 'sc-padding-right'); ?>"><span class="flag flag-cn"></span></td>
                                    <td><strong>China</strong></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(10000,100000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(10000,100000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(10000,100000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(10000,100000), 0, ',', ' ');?></td>
                                    <td class="uk-text-nowrap"><?php echo number_format(rand(10000,100000), 0, ',', ' ');?></td>
								...
								<li class="sc-list-group">
									...
									<div class="sc-list-body">
										<div class="uk-flex uk-flex-middle">
											...
											<span class="uk-label md-bg-grey-600 <?php rtlReplace('uk-margin-small-left', 'uk-margin-small-right'); ?> sc-flex-no-shrink">Other</span>
										</div>
									</div>
								</li>
								<li class="sc-list-group">
									...
									<div class="sc-list-body">
										<div class="uk-flex uk-flex-middle">
											<div class="uk-flex uk-flex-middle uk-flex-1 uk-text-truncate">
												<i class="mdi mdi-airplane sc-icon-24 <?php rtlReplace('uk-margin-small-right', 'uk-margin-small-left'); ?>"></i>
												<label for="todo-item-2">Book flight to Dublin</label>
											</div>
											<span class="uk-label md-bg-green-400 <?php rtlReplace('uk-margin-small-left', 'uk-margin-small-right'); ?> sc-flex-no-shrink">Family</span>
										</div>
									</div>
								</li>
								<li class="sc-list-group">
									...
									<div class="sc-list-body">
										<div class="uk-flex uk-flex-middle">
											<div class="uk-flex-1 uk-text-truncate">
												<label for="todo-item-3">Call <strong><?php echo $faker->name; ?></strong><span>Short descriprtion&hellip;</span></label>
											</div>
											<span class="uk-label md-bg-blue-400 <?php rtlReplace('uk-margin-small-left', 'uk-margin-small-right'); ?> sc-flex-no-shrink">Work</span>
										</div>
									</div>
								</li>
								<li class="sc-list-group">
									...
									<div class="sc-list-body">
										<div class="uk-flex uk-flex-middle">
											...
											<span class="uk-label md-bg-red-400 <?php rtlReplace('uk-margin-small-left', 'uk-margin-small-right'); ?> sc-flex-no-shrink">Important</span>
										</div>
									</div>
								</li>
								<li class="sc-list-group">
									...
									<div class="sc-list-body">
										<div class="uk-flex uk-flex-middle">
											<div class="uk-flex-1 uk-text-truncate">
												<label for="todo-item-5">Email team for updates <span>BCC: <?php echo $faker->email;?></span></label>
											</div>
											<span class="uk-badge md-bg-blue-400 <?php rtlReplace('uk-margin-small-left', 'uk-margin-small-right'); ?> sc-flex-no-shrink">Work</span>
										</div>
									</div>
								</li>
							</ul>
