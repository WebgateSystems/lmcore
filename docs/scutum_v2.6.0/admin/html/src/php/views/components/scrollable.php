		...
		<div class="uk-grid uk-child-width-1-2@m" data-uk-grid>
			...
			<div>
				<div class="uk-card">
					...
					<div class="uk-card-body">
						<div class="uk-height-small sc-js-scrollable">
			...
			<div>
				<div class="uk-card">
					...
					<div class="uk-card-body">
						<div class="uk-height-large sc-js-scrollable">
					...
					<div class="uk-card-body">
						<div class="uk-grid uk-child-width-auto" data-uk-grid>
							<div>
								...
								<div class="uk-drop" data-uk-drop="pos: bottom-left">
									<div class="uk-card">
										<div class="uk-card-body">
											<div class="uk-height-small sc-js-scrollable">
							...
							<div>
								...
								<div class="uk-dropdown-small uk-dropdown" data-uk-dropdown="pos: bottom-left">
									<ul class="uk-nav uk-dropdown-nav uk-height-small sc-js-scrollable">
										<li>
