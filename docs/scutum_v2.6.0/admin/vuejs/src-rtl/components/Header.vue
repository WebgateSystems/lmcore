<template>
	<header id="sc-header" ref="header">
		<nav class="uk-navbar uk-navbar-container" data-uk-navbar="mode: click; duration: 360">
			<div class="uk-navbar-right nav-overlay-small uk-margin-left uk-navbar-aside">
			...
			<div v-if="!vxTopMenuActive" class="uk-navbar-right nav-overlay uk-margin-left uk-visible@m">
			...
			<div v-if="vxTopMenuActive" id="sc-top-menu" class="uk-navbar-right nav-overlay nav-overlay-small">
				<ScTopMenu :menu-data="topMenuData" />
			</div>
			<div class="nav-overlay nav-overlay-small uk-navbar-left uk-flex-1" hidden>
			...
			<div class="nav-overlay nav-overlay-small uk-navbar-left">
				...
				<a v-if="vxOffcanvasPresent" href="javascript:void(0)" class="md-color-white uk-margin-right uk-hidden@l" @click="toggleOffcanvas">
