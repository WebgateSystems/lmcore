					...
					<ScCard>
						<ScCardHeader>
							<div class="uk-flex uk-flex-middle">
								...
								<i data-uk-icon="icon: commenting; ratio: 1.5" class="uk-margin-right md-color-red-600"></i>
							</div>
						</ScCardHeader>
						<ScCardBody>
										...
										<div class="uk-form-controls">
											<ul class="uk-list">
												<li v-for="option in seenMedium" :key="option.id">
													...
													<input v-if="option.input" v-model="userData.seenMediumOther" type="text" class="uk-input uk-display-inline-block uk-form-width-small uk-margin-small-right uk-form-small">
												</li>
											</ul>
										</div>
									</div>
