	...
	<div v-if="issue" id="sc-page-wrapper">
		<div id="sc-page-top-bar" class="sc-top-bar">
			<div class="sc-top-bar-content sc-padding-medium-top sc-padding-medium-bottom uk-flex-1">
				<div class="uk-flex-1">
					<h1 v-if="issue.title" class="sc-top-bar-title">
						{{ issue.title }}
					</h1>
				...
				<div class="sc-actions uk-margin-right uk-visible@s">
					...
					<div class="uk-grid uk-grid-divider uk-grid" data-uk-grid>
						<div class="uk-width-3-4@l">
							<div class="uk-flex uk-flex-wrap" data-uk-margin>
								<button class="sc-button sc-button-flex uk-margin-small-left">
									<i class="mdi mdi-pencil-outline uk-margin-small-left"></i>
									Edit
								</button>
									...
									<li>
										<article class="uk-comment uk-visible-toggle" tabindex="-1">
											<header class="uk-comment-header uk-position-relative">
												...
												<div class="uk-position-top-left uk-margin-small-top uk-margin-small-left uk-hidden-hover">
							...
							<ul class="uk-list uk-list-divider uk-margin-small-top">
								<li class="sc-list-group">
									...
									<div class="sc-list-body">
										<div>
											<span class="sc-color-secondary uk-margin-small-left">Status:</span>
								...
								<li class="sc-list-group">
									...
									<div class="sc-list-body">
										<div>
											<span class="sc-color-secondary uk-margin-small-left">Priority:</span>
