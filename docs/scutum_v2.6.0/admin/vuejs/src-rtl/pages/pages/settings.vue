									...
									<li class="uk-active">
										<a href="javascript:void(0)">
											<span class="uk-flex uk-flex-middle uk-text-medium sc-text-semibold">
												<i class="mdi mdi-cogs uk-margin-medium-left"></i>Basic Settings
											</span>
										</a>
									</li>
									<li>
										<a href="javascript:void(0)">
											<span class="uk-flex uk-flex-middle uk-text-medium sc-text-semibold">
												<i class="mdi mdi-account-group uk-margin-medium-left"></i>Users
											</span>
										</a>
									</li>
									<li>
										<a href="javascript:void(0)">
											<span class="uk-flex uk-flex-middle uk-text-medium sc-text-semibold">
												<i class="mdi mdi-brush uk-margin-medium-left"></i>Appearance
											</span>
										</a>
									</li>
									<li>
										<a href="javascript:void(0)">
											<span class="uk-flex uk-flex-middle uk-text-medium sc-text-semibold">
												<i class="mdi mdi-puzzle-outline uk-margin-medium-left"></i>Plugins
											</span>
										</a>
									</li>
								</ul>
