	...
	<div id="sc-page-wrapper" class="uk-flex uk-flex-column">
		<div id="sc-page-top-bar" class="sc-top-bar">
			...
			<div class="sc-top-bar-content uk-flex-1">
				...
				<div v-if="$route.name !== 'pages-mailbox-compose'" class="sc-actions" :class="{'uk-margin-medium-right': $route.name === 'pages-mailbox'}">
								...
								<ul class="uk-list">
									<li>
										<a href="javascript:void(0)">
											<i class="mdi mdi-inbox uk-margin-small-left"></i>Inbox (24)
										</a>
									</li>
									<li>
										<a href="javascript:void(0)">
											<i class="mdi mdi-inbox-arrow-up uk-margin-small-left"></i>Sent
										</a>
									</li>
									<li>
										<a href="javascript:void(0)">
											<i class="mdi mdi-block-helper uk-margin-small-left sc-icon-22"></i>Spam
										</a>
									</li>
									<li>
										<a href="javascript:void(0)">
											<i class="mdi mdi-delete uk-margin-small-left"></i>Trash
										</a>
									</li>
								</ul>
							</div>
		...
		<client-only>
			<ScOffcanvas v-if="$route.name === 'pages-mailbox'" :key="mailboxOffcanvas">
				...
				<ul class="uk-list uk-margin-remove sc-list-align">
					<li><a href="javascript:void(0)"><i class="mdi mdi-inbox uk-margin-small-left"></i>Inbox (24)</a></li>
					<li><a href="javascript:void(0)"><i class="mdi mdi-inbox-arrow-up uk-margin-small-left"></i>Sent</a></li>
					<li><a href="javascript:void(0)"><i class="mdi mdi-block-helper uk-margin-small-left sc-icon-22"></i>Spam</a></li>
					<li><a href="javascript:void(0)"><i class="mdi mdi-delete uk-margin-small-left"></i>Trash</a></li>
				</ul>
			</ScOffcanvas>
		</client-only>
