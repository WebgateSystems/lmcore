					...
					<div class="uk-child-width-1-1@l uk-child-width-1-2@m uk-grid" data-uk-grid>
						<div>
							<Transition name="scale-up">
								<ScCard v-if="!trafficCardClosed" ref="trafficCard" dir="ltr">
									<ScCardHeader>
										<div class="uk-flex uk-flex-middle">
											<div class="uk-flex-1">
												<ScCardTitle>
						...
						<div>
							<Transition name="scale-up">
								<ScCard v-if="!bestSellersCardClosed" ref="trafficCard" dir="ltr">
									<ScCardHeader>
										<div class="uk-flex uk-flex-middle">
											<div class="uk-flex-1">
												<ScCardTitle>
									...
									<table class="uk-table uk-table-divider uk-table-striped uk-table-hover uk-table-middle uk-margin-remove">
										...
										<tbody>
											<tr @mouseenter="highlightRegion('br')" @mouseleave="unhighlightRegion('br')">
												<td class="uk-table-shrink sc-padding-right">
										...
										<li class="sc-list-group" :class="{'sc-item-checked': todo.item1}">
											...
											<div class="sc-list-body" @click="todo.item1 = !todo.item1">
												<div class="uk-flex uk-flex-middle">
													...
													<span class="uk-label md-bg-grey-600 uk-margin-small-right sc-flex-no-shrink">
														Other
													</span>
												</div>
											</div>
										...
										<li class="sc-list-group" :class="{'sc-item-checked': todo.item2}">
											...
											<div class="sc-list-body" @click="todo.item2 = !todo.item2">
												<div class="uk-flex uk-flex-middle">
													...
													<span class="uk-label md-bg-green-400 uk-margin-small-right sc-flex-no-shrink">
														Family
													</span>
												</div>
											</div>
										...
										<li class="sc-list-group" :class="{'sc-item-checked': todo.item3}">
											...
											<div class="sc-list-body" @click="todo.item3 = !todo.item3">
												<div class="uk-flex uk-flex-middle">
													...
													<span class="uk-label md-bg-blue-400 uk-margin-small-right sc-flex-no-shrink">
														Work
													</span>
												</div>
											</div>
										...
										<li class="sc-list-group" :class="{'sc-item-checked': todo.item4}">
											...
											<div class="sc-list-body" @click="todo.item4 = !todo.item4">
												<div class="uk-flex uk-flex-middle">
													...
													<span class="uk-label md-bg-red-400 uk-margin-small-right sc-flex-no-shrink">
														Important
													</span>
												</div>
											</div>
	...
	data: () => ({
		...
		traficChart: {
			options: {
				...
				maintainAspectRatio: false,
				legend: {
					position: scMq.mediumMin() ? 'left' : 'bottom'
				},
				title: {
					display: false
				},
