					...
					<div class="uk-child-width-1-3@s uk-grid-collapse uk-grid-divider uk-grid" data-uk-grid>
						<div>
							<div class="sc-padding sc-padding-medium-ends">
								<p>Panel A</p>
								<ScTextarea v-model="panelA" mode="outline" :autosize="true" dir="ltr"></ScTextarea>
							</div>
						</div>
						<div>
							<div class="sc-padding sc-padding-medium-ends">
								<p>Panel B</p>
								<ScTextarea v-model="panelB" mode="outline" :autosize="true" dir="ltr"></ScTextarea>
							</div>
						</div>
						<div>
							<div class="sc-padding sc-padding-medium-ends">
								<p>Result</p>
								<pre ref="resultPanel" dir="ltr"></pre>
							</div>
						</div>
					</div>
				</div>
