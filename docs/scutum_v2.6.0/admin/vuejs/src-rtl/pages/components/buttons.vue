								...
								<div class="uk-width-auto uk-flex-middle uk-grid-medium uk-grid" data-uk-grid>
									<div>
										<button class="sc-button sc-button-flex">
											<span data-uk-icon="icon: sign-in" class="uk-margin-small-left"></span>
											Sign In
										</button>
									</div>
									<div>
										<button class="sc-button sc-button-flex sc-button-red">
											<span class="md-color-orange-600 uk-margin-small-left" data-uk-icon="icon: settings"></span>
											Settings
										</button>
									</div>
									<div>
										<button class="sc-button sc-button-flex">
											<i class="mdi mdi-chart-areaspline uk-margin-small-left"></i>
											Charts
										</button>
									</div>
								</div>
						...
						<ScCardBody>
							<div class="uk-child-width-auto@m uk-grid" data-uk-grid>
								<div>
									...
									<span class="uk-form-help-block uk-margin-remove-right">
										Replace text
									</span>
								</div>
								<div>
...
export default {
	...
	methods: {
		...
		buttonReplaceContent () {
			...
			setTimeout(() => {
				this.btnContent = 'New replaced text <i class="mdi mdi-emoticon-happy-outline uk-margin-small-right"></i>';
