					...
					<ScCard :loading="cardCLoading">
						<ScCardHeader separator>
							<div class="uk-flex uk-flex-middle">
								...
								<ScCardActions class="uk-margin-right">
									<a
										href="javascript:void(0)"
					...
					<ScCard :full-screen="cardFFullScreen">
						<ScCardHeader separator>
							<div class="uk-flex uk-flex-middle">
								<a
									href="javascript:void(0)"
									class="sc-actions-icon mdi mdi-arrow-right sc-card-fs-visible uk-margin-left"
...
&lt;/ScCard&gt;</code></pre>
				...
				<div>
					<ScCard>
						...
						<ScCardBody class="sc-padding-bottom sc-padding-remove-right sc-padding-remove-right">
							<pre class="sc-js-highlight"><code>&lt;ScCard&gt;
	&lt;ScCardTitle class=&quot;sc-padding-ends&quot;&gt;...&lt;/ScCardTitle&gt;
	&lt;ScCardBody class=&quot;sc-padding-bottom sc-padding-remove-right sc-padding-remove-right&quot;&gt;...&lt;/ScCardBody&gt;
&lt;/ScCard&gt;</code></pre>
							<p>
								Lorem ipsum <a href="javascript:void(0)">
									dolor
