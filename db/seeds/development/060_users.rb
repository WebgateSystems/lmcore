...
@super_admin = create_user_with_role({
  ...
  first_name: 'Super',
  last_name: 'Admin',
  display_name_i18n: { en: 'Super Admin' },
...
@admin = create_user_with_role({
  ...
  first_name: 'Admin',
  last_name: 'User',
  display_name_i18n: { en: 'Admin User' },
...
@moderator = create_user_with_role({
  ...
  first_name: 'Maria',
  last_name: 'Moderator',
  display_name_i18n: { en: 'Maria Moderator', pl: 'Maria Moderator' },
...
@editor = create_user_with_role({
  ...
  first_name: 'Edward',
  last_name: 'Editor',
  display_name_i18n: { en: 'Edward Editor' },
...
@author_pl = create_user_with_role({
  ...
  first_name: 'Jan',
  last_name: 'Kowalski',
  display_name_i18n: { pl: 'Jan Kowalski', en: 'Jan Kowalski', uk: 'Ян Ковальський' },
...
@author_uk = create_user_with_role({
  ...
  first_name: 'Олена',
  last_name: 'Шевченко',
  display_name_i18n: { uk: 'Олена Шевченко', en: 'Olena Shevchenko', pl: 'Olena Szewczenko', ru: 'Олена Шевченко' },
...
@author_lt = create_user_with_role({
  ...
  display_name_i18n: { lt: 'Jonas Kazlauskas', en: 'Jonas Kazlauskas', pl: 'Jonas Kazlauskas' },
